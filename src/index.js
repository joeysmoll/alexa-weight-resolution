...
var handlers = {
    ...
    'LaunchIntent': function() {
        if (this.attributes['setStartingWeight'] == null) {
            this.emit(':ask', 'Hello, I am Weight Bot, your weight tracking assistant. Its time to set up a starting weight. Your starting weight will be used to track long term weight changes. Please say the number of pounds you currently weigh.');
        } else {
    ...
    'AMAZON.YesIntent': function() {
        ...
        if (this.attributes['setStartingWeight'] == null){
            ...
            this.emit(':tell', 'Your starting weight of ' + this.attributes["startingWeight"] + ' pounds has been saved. When recording your weight in the future you can quickly record your weight by saying something like, Alexa, tell weight bot, one hundred and seventy-five point two pounds. You can also ask for help, so you can get an idea of the different commands that you can say.');
        } else {
            //push daily weight
    ...
    'ResetWeightBot': function(){
        this.emit(':ask', 'Resetting weight bot will clear your weight data and will prompt you for your new starting weight. Please say. confirm reset. this will reset weight bot.');
    },
